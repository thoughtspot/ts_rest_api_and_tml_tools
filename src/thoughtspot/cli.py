...
def info(
    ts_server: str = O_(..., help="your ThoughtSpot cluster URL", envvar="TS_SERVER", prompt=True),
    ts_username: str = O_(..., help="your ThoughtSpot local user", envvar="TS_USERNAME", prompt=True),
    ts_password: str = O_(
        ...,
...
def prep(
    ...
    isort = ("isort", "--length-sort", "--reverse-sort", example_subdirectory.as_posix())

    black = ("black", "--line-length", "120", "--target-version", "py36", example_subdirectory.as_posix())
