...
fetch_connection_response = ts.tsrest.connection_fetch_connection(connection_guid=connection_guid,
...
dbs_with_schemas = ts.tsrest.get_databases_and_schemas_from_connection(external_databases_from_fetch_connection=external_dbs,
                                                                       schema_names_to_skip=['INFORMATION_SCHEMA'])
...
selected_external_databases = ts.tsrest.get_selected_tables_from_connection(external_databases_from_fetch_connection=external_dbs,
...
update_metadata_obj = ts.tsrest.add_new_tables_to_connection(selected_external_databases=selected_external_databases,
                                                             tables_to_add_map=to_add_map,
