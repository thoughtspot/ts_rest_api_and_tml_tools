...
response = ts.tsrest.connection_create(
    connection_name="My Great Connection",
    connection_type="RDBMS_SNOWFLAKE",
    metadata_json=conn_json,
    description="Connection Descr",
...
ts.tsrest.connection_update(
    connection_guid=new_connection_guid,
    connection_name="My Even Greater Connection",
    connection_type="RDBMS_SNOWFLAKE",
    metadata_json=conn_json,
    description="Connection Descr 2",
    create_without_tables=True,
    use_internal_endpoint=False,
)
