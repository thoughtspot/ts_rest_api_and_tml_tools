...
def download_objects_to_directory(root_directory, object_type, object_guid_list=None, category_filter=None):
    ...
    objs = ts.tsrest.metadata_listobjectheaders(
        object_type=object_type,
        sort="MODIFIED",
        sort_ascending=False,
        category=category_filter,
        fetchids=object_guid_list,
    )
    ...
    for obj in objs:
        ...
        with open(
            "{}/{}/{}.{}.tml".format(
                root_directory, object_type_directory_map[object_type], guid, object_type_directory_map[object_type]
            ),
            "w",
            encoding="utf-8",
        ) as f:
